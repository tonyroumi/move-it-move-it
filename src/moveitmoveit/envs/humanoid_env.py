...
def compute_reward_terms(
    ...
    instead of summed, so each scaled contribution can be logged independently."""
    ...
    # `total_reward` fully overrides the sum with `death_cost` for terminated envs, so zero
